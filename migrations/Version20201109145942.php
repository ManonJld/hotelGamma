 ...
 */
final class Version20201109145942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE accomodation (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, category_id INT DEFAULT NULL, photo VARCHAR(255) NOT NULL, beds SMALLINT NOT NULL, persons SMALLINT NOT NULL, size INT NOT NULL, price NUMERIC(5, 2) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_520D81B3C54C8C93 (type_id), INDEX IDX_520D81B312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE amenity_accomodation (amenity_id INT NOT NULL, accomodation_id INT NOT NULL, INDEX IDX_3E089F19F9F1305 (amenity_id), INDEX IDX_3E089F1FD70509C (accomodation_id), PRIMARY KEY(amenity_id, accomodation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE amenity_accomodation ADD CONSTRAINT FK_3E089F19F9F1305 FOREIGN KEY (amenity_id) REFERENCES amenity (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE amenity_accomodation ADD CONSTRAINT FK_3E089F1FD70509C FOREIGN KEY (accomodation_id) REFERENCES accomodation (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE amenity_accomodation DROP FOREIGN KEY FK_3E089F1FD70509C');
        ...
        $this->addSql('ALTER TABLE amenity_accomodation DROP FOREIGN KEY FK_3E089F19F9F1305');
        ...
        $this->addSql('DROP TABLE amenity_accomodation');
